...
enum yysymbol_kind_t
{
  ...
  YYSYMBOL_DIFF = 17,                      /* DIFF  */
  YYSYMBOL_LPAR = 18,                      /* LPAR  */
  YYSYMBOL_RPAR = 19,                      /* RPAR  */
  YYSYMBOL_LBRC = 20,                      /* LBRC  */
  YYSYMBOL_RBRC = 21,                      /* RBRC  */
  YYSYMBOL_LBRT = 22,                      /* LBRT  */
  YYSYMBOL_RBRT = 23,                      /* RBRT  */
  YYSYMBOL_PLUS = 24,                      /* PLUS  */
  YYSYMBOL_MINUS = 25,                     /* MINUS  */
  YYSYMBOL_MULT = 26,                      /* MULT  */
  YYSYMBOL_DIVI = 27,                      /* DIVI  */
  YYSYMBOL_COMMA = 28,                     /* COMMA  */
  YYSYMBOL_ASSIGN = 29,                    /* ASSIGN  */
  YYSYMBOL_ERROR = 30,                     /* ERROR  */
  YYSYMBOL_YYACCEPT = 31,                  /* $accept  */
  YYSYMBOL_programa = 32,                  /* programa  */
  YYSYMBOL_33_declaracao_lista = 33,       /* declaracao-lista  */
  YYSYMBOL_declaracao = 34,                /* declaracao  */
  YYSYMBOL_id = 35,                        /* id  */
  YYSYMBOL_num = 36,                       /* num  */
  YYSYMBOL_37_var_declaracao = 37,         /* var-declaracao  */
  YYSYMBOL_38_tipo_especificador = 38,     /* tipo-especificador  */
  YYSYMBOL_39_fun_declaracao = 39,         /* fun-declaracao  */
  YYSYMBOL_40_1 = 40,                      /* @1  */
  ...
  YYSYMBOL_45_local_declaracoes = 45,      /* local-declaracoes  */
  YYSYMBOL_46_statement_lista = 46,        /* statement-lista  */
  YYSYMBOL_statement = 47,                 /* statement  */
  YYSYMBOL_48_expressao_decl = 48,         /* expressao-decl  */
  YYSYMBOL_49_selecao_decl = 49,           /* selecao-decl  */
  YYSYMBOL_50_iteracao_decl = 50,          /* iteracao-decl  */
  YYSYMBOL_51_retorno_decl = 51,           /* retorno-decl  */
  YYSYMBOL_expressao = 52,                 /* expressao  */
  YYSYMBOL_var = 53,                       /* var  */
  YYSYMBOL_54_2 = 54,                      /* @2  */
  YYSYMBOL_55_simples_expressao = 55,      /* simples-expressao  */
  YYSYMBOL_relacional = 56,                /* relacional  */
  YYSYMBOL_57_soma_expressao = 57,         /* soma-expressao  */
  ...
  YYSYMBOL_65_arg_lista = 65               /* arg-lista  */
};
...
static const yytype_uint8 yyrline[] =
{
      ...
      76,    79,    80,    83,    83,    86,    87,    90,    91,    94,
      95,    98,   101,   102,   105,   106,   109,   110,   111,   112,
     113,   116,   117,   120,   121,   124,   127,   128,   131,   132,
     135,   136,   136,   139,   140,   143,   144,   145,   146,   147,
     148,   151,   152,   155,   156,   159,   160,   163,   164,   167,
     168,   169,   170,   173,   173,   176,   177,   180,   181
};
#endif
...
static const char *const yytname[] =
{
  ...
  "VOID", "WHILE", "ELSE", "ID", "NUM", "LT", "LET", "GT", "GET", "EQUAL",
  "SEMI", "DIFF", "LPAR", "RPAR", "LBRC", "RBRC", "LBRT", "RBRT", "PLUS",
  "MINUS", "MULT", "DIVI", "COMMA", "ASSIGN", "ERROR", "$accept",
  "programa", "declaracao-lista", "declaracao", "id", "num",
  "var-declaracao", "tipo-especificador", "fun-declaracao", "@1", "params",
  "param-lista", "param", "composto-decl", "local-declaracoes",
  "statement-lista", "statement", "expressao-decl", "selecao-decl",
  "iteracao-decl", "retorno-decl", "expressao", "var", "@2",
  "simples-expressao", "relacional", "soma-expressao", "soma", "termo",
  "mult", "fator", "ativacao", "@3", "args", "arg-lista", YY_NULLPTR
};
...
{
      54,   -81,   -81,     7,    54,   -81,   -81,    35,   -81,   -81,
     -81,   -81,    17,   -81,     6,     8,   -81,    30,    60,    49,
      38,    35,    52,    44,   -81,   -81,    51,    55,    54,    53,
     -81,   -81,   -81,   -81,    54,   -81,    35,     1,    17,    56,
      25,    59,   -81,    27,   -81,   -13,   -81,   -81,   -81,   -81,
     -81,   -81,   -81,    62,    50,   -81,    37,    41,   -81,   -81,
      27,   -81,    64,    27,    63,    61,    66,   -81,    27,   -81,
     -81,   -81,   -81,   -81,   -81,   -81,   -81,    27,    27,   -81,
     -81,    27,    67,   -81,    68,   -81,    27,    27,   -81,   -81,
      45,    41,   -81,    22,    22,    58,   -81,    69,    57,    81,
     -81,   -81,   -81,    27,    22,   -81,   -81
};
...
static const yytype_int8 yydefact[] =
{
      ...
      28,    29,    30,     0,    60,    39,    44,    52,    56,    61,
       0,    36,     0,     0,     0,     0,     0,    31,     0,    46,
      45,    47,    48,    49,    50,    53,    54,     0,     0,    57,
...
{
     -81,   -81,   -81,    86,    -6,    77,    65,   -16,   -81,   -81,
     -81,   -81,    70,    73,   -81,   -81,   -80,   -81,   -81,   -81,
     -81,   -40,   -22,   -81,   -81,   -81,    15,   -81,    16,   -81,
      12,   -81,   -81,   -81,   -81
};
...
{
      62,    12,    21,    64,    39,   -63,    40,     9,    41,   -41,
      11,    16,    21,    99,   100,    26,    16,    42,    36,    43,
      82,    30,    44,    84,   106,    39,    18,    40,    88,    41,
      38,    11,    16,    13,    11,    16,    11,    16,    42,    14,
      43,    61,    30,    43,    11,    43,    95,    96,    69,    70,
      71,    72,    73,    19,    74,    89,    89,   -16,     1,    89,
       2,    75,    76,   105,     1,    25,    20,    79,    80,    75,
      76,    27,    28,    29,    60,    30,    33,    63,    67,    68,
      83,   101,    85,    86,    87,   103,    93,    94,   102,   104,
      10,    17,    90,    92,    91,     0,     0,     0,    32,    35,
      31
};

static const yytype_int8 yycheck[] =
{
      40,     7,    18,    43,     3,    18,     5,     0,     7,    22,
       9,    10,    28,    93,    94,    21,    10,    16,    34,    18,
      60,    20,    21,    63,   104,     3,    18,     5,    68,     7,
      36,     9,    10,    16,     9,    10,     9,    10,    16,    22,
      18,    16,    20,    18,     9,    18,    86,    87,    11,    12,
      13,    14,    15,    23,    17,    77,    78,    19,     4,    81,
       6,    24,    25,   103,     4,    16,     6,    26,    27,    24,
      25,    19,    28,    22,    18,    20,    23,    18,    16,    29,
      16,    23,    19,    22,    18,    28,    19,    19,    19,     8,
       4,    14,    77,    81,    78,    -1,    -1,    -1,    28,    34,
      27
};
...
{
       0,     4,     6,    32,    33,    34,    37,    38,    39,     0,
      34,     9,    35,    16,    22,    40,    10,    36,    18,    23,
       6,    38,    41,    42,    43,    16,    35,    19,    28,    22,
      20,    44,    43,    23,    45,    37,    38,    46,    35,     3,
       5,     7,    16,    18,    21,    35,    36,    44,    47,    48,
      49,    50,    51,    52,    53,    55,    57,    59,    61,    62,
      18,    16,    52,    18,    52,    54,    63,    16,    29,    11,
      12,    13,    14,    15,    17,    24,    25,    56,    58,    26,
      27,    60,    52,    16,    52,    19,    22,    18,    52,    53,
...
#line 1296 "cminus.tab.c"
  ...
  case 16: /* params: VOID  */
#line 87 "cminus.y"
                  { yyval = newDeclNode(FunParDeclK); yyval->type = Void; yyval->attr.name = NULL; }
